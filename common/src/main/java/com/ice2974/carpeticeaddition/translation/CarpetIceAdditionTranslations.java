    ...
    public static Map<String, String> get(String lang) {
        if (lang != null && lang.toLowerCase().startsWith("zh")) {
            return Map.ofEntries(
                    ...
                    Map.entry("carpet.rule.iceLikeMagmaBlocks.name", "\u7c7b\u51b0\u5ca9\u6d46\u5757"),
                    Map.entry("carpet.rule.iceLikeMagmaBlocks.desc", "\u5141\u8bb8\u73a9\u5bb6\u4f7f\u7528\u4e0d\u5e26\u7cbe\u51c6\u91c7\u96c6\u7684\u5de5\u5177\u7834\u574f\u5ca9\u6d46\u5757\u65f6\uff0c\u6839\u636e\u7c7b\u4f3c\u51b0\u5757\u7684\u5224\u5b9a\u903b\u8f91\uff0c\u5728\u4e0b\u65b9\u4e3a\u6709\u6548\u56fa\u4f53\u65b9\u5757\u6216\u6db2\u4f53\u65b9\u5757\u65f6\u751f\u6210\u5ca9\u6d46\u6e90\u3002"),
                    ...
                    Map.entry("carpet.rule.zombifiedPiglinsSpawnWithoutSpears.name", "\u7981\u6b62\u81ea\u7136\u751f\u6210\u6301\u77db\u50f5\u5c38\u732a\u7075"),
                    Map.entry("carpet.rule.zombifiedPiglinsSpawnWithoutSpears.desc", "\u50f5\u5c38\u732a\u7075\u5728\u81ea\u7136\u751f\u6210\u65f6\u4e0d\u4f1a\u624b\u6301\u957f\u77db\u3002"),
        ...
        return Map.ofEntries(
                ...
                Map.entry("carpet.rule.iceLikeMagmaBlocks.desc", "Allows magma blocks broken by players with tools without Silk Touch to generate a lava source using ice-like support checks when the block below is a valid solid block or liquid block."),
                ...
                Map.entry("carpet.rule.zombifiedPiglinsSpawnWithoutSpears.desc", "Prevents naturally spawned zombified piglins from holding spears."),
