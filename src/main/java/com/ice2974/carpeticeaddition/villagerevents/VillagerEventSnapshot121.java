...
public record VillagerEventSnapshot121(long sequence, String dimensionId, int x, int y, int z, Component identity, Component fallbackIdentity, Component deathMessage) {
