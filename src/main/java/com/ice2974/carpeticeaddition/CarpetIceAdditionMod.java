    ...
    public Map<String, String> canHasTranslations(String lang) {
        if (lang != null && lang.toLowerCase().startsWith("zh")) {
            return Map.ofEntries(
                    ...
                    Map.entry("carpet.rule.spawnersIgnoreInvisiblePlayers.desc", "\u542f\u7528\u540e\uff0c\u666e\u901a\u5237\u602a\u7b3c\u3001\u8bd5\u70bc\u5237\u602a\u7b3c\u548c\u4e0d\u7965\u8bd5\u70bc\u5237\u602a\u7b3c\u5728\u5224\u5b9a\u9644\u8fd1\u73a9\u5bb6\u65f6\u4f1a\u5ffd\u7565\u9690\u8eab\u73a9\u5bb6\u3002"),
        ...
        return Map.ofEntries(
                ...
                Map.entry("carpet.rule.spawnersIgnoreInvisiblePlayers.desc", "Invisible players do not activate normal spawners, trial spawners, or ominous trial spawners."),
