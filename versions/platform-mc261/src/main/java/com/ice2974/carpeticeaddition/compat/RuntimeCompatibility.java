...
public final class RuntimeCompatibility {
    private static final String LOADER_MIN = "0.18.6";
    private static final String FABRIC_API_MIN = "0.142.1+26.1";
    private static final String CARPET_MIN = "26.1-beta-1";
    ...
    public boolean shouldEnableSpawnersIgnoreInvisiblePlayers() {
        return loader.compatible && carpet.compatible && fabricApi.compatible;
    }
