 ...
 *
 * <p>珊瑚块配方为 3×3，玩家只能在 3×3 工作台合成，故只需刷新 {@code CraftingMenu}（mojmap）。
 * 通过 {@link CraftableCoralCraftingRefresher} duck 接口识别目标菜单，避免依赖具体版本类名。
 */
public final class CraftingRefresherDispatcher {
    ...
    public static void refreshOpenCraftingMenu(Player player) {
        ...
        if (menu instanceof CraftableCoralCraftingRefresher refresher) {
            try {
