...
public final class CraftableCoralBlocksDataPackController {
    public static final ResourceLocation PACK_ID = ResourceLocation.tryParse("carpet-ice-addition:craftable_coral_blocks");
    ...
    private static void startReload(MinecraftServer minecraftServer, boolean target) {
        Collection<String> selected = minecraftServer.getPackRepository().getSelectedIds();
    ...
    private static boolean isPackEnabled(MinecraftServer minecraftServer) {
        return minecraftServer.getPackRepository().getSelectedIds().contains(PACK_ID.toString());
    }
