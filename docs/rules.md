...
当村民被命名为 trade 时，将其 AI 精简为面向固定式村民交易所的最小行为集：村民不自主移动或寻路，但可认领身边约 1.73 格内的工作站，并按原版职业规则失业与恢复职业，补货等原版限制全部保留，交易、职业升级与新货单不受影响。

本规则面向固定式交易所：工作站需放在村民身边约 1.73 格（补货判定距离）范围内，推荐贴身或相邻放置；认领不检查可达性，隔墙相邻的工作站同样可以被认领。优化期间村民不会自主走动、寻路或走向工作站，也不会主动寻找或寻路捡拾物品（被水流等外力推到身上的物品仍可被拾取），不再开门、面向玩家、闲逛、社交、恐慌、睡觉、繁殖、传播流言或参与召唤铁傀儡；补货保留原版工作行为，每日补货次数、两次补货间隔与跨日重置等原版限制全部保留，已有 gossip 与声誉对交易价格的影响继续生效。职业生命周期保持原版语义：工作站被拆除或失效后，未交易且未获得经验的村民按原版条件失业；已交易或获得经验而锁职的村民保留职业并解除工作站绑定；两种村民都会在身边约 1.73 格内重新出现可认领的匹配工作站时自动认领——失业村民可认领任意类型工作站并按工作站获得职业，锁职村民只会认领同职业工作站，傻瓜村民不会认领——认领后自动恢复补货，全程不产生移动或寻路，放在远处的工作站不会被认领。村民仍可通过外力、船、矿车、水流等方式移动（不会主动寻路上载具），落水时仍会尝试跳跃自救；若村民在认领完成前被外力移出范围，未完成的认领会自动释放并在村民回到范围内后重试。名称匹配区分大小写，需精确等于小写 `trade`。改名、移除名称或关闭规则后，村民会通过原版 Brain 重建恢复完整 AI，不写入任何依赖本模组的存档数据。
